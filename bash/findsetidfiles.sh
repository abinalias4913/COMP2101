...
#Listing the setgid files(and the command 2000 is given and it is the permission )
echo "Setgid files:"
echo "============="
...
#this command list 10 files which is the largest files in system and are sorted by their file size, file name and owner.
